...
- [ ] TXXX [P] End-to-end journeys covering every user story in this feature
- [ ] TXXX Coverage audit: for each layer this feature touched, confirm a test
      task exists and the test fails without the change; record any waiver
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX Security hardening
- [ ] TXXX Run the full test suite and quickstart.md validation
...
- Tests MUST be written and MUST be observed failing before implementation
...
```bash
# Launch all tests for User Story 1 together (always written first):
